...
public class NotificareServicesPluginTest {
    @Test
    public void testNoFlavor() {
        List<String> output = toStringList(NotificareServicesTask.getJsonLocations("release"));
    ...
    public void testOneFlavor() {
        List<String> output =
                toStringList(NotificareServicesTask.getJsonLocations("flavor/release"));
        assertThat(output)
                .containsAllOf(
                        "src/release",
                        "src/flavorRelease",
    ...
    public void testMultipleFlavors() {
        List<String> output =
                toStringList(NotificareServicesTask.getJsonLocations("flavorTest/release"));
        assertThat(output)
                .containsAllOf(
                        "src/release",
                        "src/flavorRelease",
